  ...
  return (
    <>
      <CardContainerAssiettes>
        <CardTitle>Les entrées du Fumoir 8,20€</CardTitle>
        <CardMenuTextDesc items={entrees} fallback={'Loading...'} />
      </CardContainerAssiettes>
      <CardContainerAssiettes>
      ...
      <CardContainerAssiettes>
        <CardTitle>Les plats chauds Maison 17,10€</CardTitle>
        <CardMenuTextDesc items={platsChauds} fallback={'Loading...'} />
      </CardContainerAssiettes>
      <CardContainer>
      ...
      <CardContainer>
        <CardTitle>Saucissons à partager</CardTitle>
        <CardMenuTextPrice items={aPartager} fallback={'Loading...'} />
      </CardContainer>
      <CardMenuVinGroup>
